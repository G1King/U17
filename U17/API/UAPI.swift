...
extension API: TargetType{
    ...
    var headers: [String : String]? { return ["app-version": APP_VERSION as! String] }
    
}
extension Response {
    func mapModel<U: HandyJSON>(_ type: U.Type) throws -> U {
        let json = String(data: data, encoding: .utf8)
        guard let model = JSONDeserializer<U>.deserializeFrom(json: json) else { throw MoyaError.jsonMapping(self) }
